package com.xyj.common.tool.template;
...
public class FreemarkerUtil {
	...
	public static void main(String[] args) {
		...
		m1.setSinger("张学友");
		m1.setUrl("http://yyc.ttpod.com/yyc/client-data!esdown.action?id=90823");

		Music m2 = new Music();
		m2.setMusicName("一路上&有你");
		m2.setSinger("张学友");
		m2.setUrl("http://yyc.ttpod.com/yyc/client-data!esdown.action?id=92671");
		...
		for (int i = 0; i < 100000; i++) {
			String s = FreemarkerUtil.makeTemplate2Str(directory, fileName,
					root);
		}
